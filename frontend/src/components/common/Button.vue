...
const variantClasses = computed(() => {
  switch (props.variant) {
    ...
    case 'secondary':
      return 'bg-white text-primary border-2 border-primary hover:bg-blue-50 focus:ring-primary';
    case 'text':
      return 'bg-transparent text-primary hover:bg-blue-50 focus:ring-primary';
    default:
      return '';
  }
});
